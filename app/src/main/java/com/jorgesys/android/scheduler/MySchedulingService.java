 ...
 * {@code MyAlarmReceiver} (a {@code WakefulBroadcastReceiver}) holds a
...
public class MySchedulingService extends IntentService {
    ...
    public static final String TAG = "MySchedulingService";
    // An ID used to post the notification.
    public static final int NOTIFICATION_ID = 1;
    // The string the app searches for in the Google home page content. If the app finds 
    // the string, it indicates the presence of a doodle.  
    public static final String SEARCH_STRING = "doodle";
    // The Google home page URL from which the app feºtches content.
    ...
    private void sendNotification(String msg) {
        Log.i(TAG, "sendNotification() is sending notification!!!");
...
//
    ...
    private String loadFromNetwork(String urlString) throws IOException {
        Log.i(TAG, "loadFromNetwork() loading to find a new Doodle!!!");
